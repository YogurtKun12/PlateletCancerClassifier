...
rf_optimal <- readRDS(file.path(getwd(), "inst", "extdata", "rf_binary_model.rds"))
saveRDS(rf_optimal, "rf_binary_model.rds")                    # Binary model
xgb_model <- readRDS(file.path(getwd(), "inst", "extdata", "xgb_multiclass_model.rds"))
saveRDS(xgb_model,"xgb_multiclass_model.rds")             # Multiclass model (new xgboost format)
